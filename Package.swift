...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230309150554.xcframework.zip",
			checksum: "54795ed3c3c00a6a11f671f6335328d6ef7401c9ccafeaea25b95f80e28b4add"
		)
	]
)