...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-3.0.0-beta.14.xcframework.zip",
			checksum: "71ed02af80c1c75350ebbafbbbc45147181e0063db29b7f116a285fbd22ce79f"
		)
	]
)