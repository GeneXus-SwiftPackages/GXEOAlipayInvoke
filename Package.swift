...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-2.0.0-beta.37.xcframework.zip",
			checksum: "3d73bdfcfc656e9a2cc7ec07da84ed5cd52a0669018ec0f885afde4d41b45268"
		)
	]
)