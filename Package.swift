...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXStandardClasses.git", exact: "1.4.29")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/releases/GXEOAlipayInvoke-1.4.29.xcframework.zip",
			checksum: "cf32745c4423ad6d169bc0e3dc61de0c97337ffa08c7e6c4c817f0bb966374f4"
		)
	]
)