...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/preview/GXEOAlipayInvoke-1.1.0-rc.5.xcframework.zip",
			checksum: "20c7ed731d7bdc07be564897940385fa3ada05b7a8f305cf292d87712de5bffb"
		)
	]
)