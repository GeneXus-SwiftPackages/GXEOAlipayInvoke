...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230525143554.xcframework.zip",
			checksum: "942be6c846a4923b7eda21486d777c41d669d806852256c4b2608200a5475ffd"
		)
	]
)