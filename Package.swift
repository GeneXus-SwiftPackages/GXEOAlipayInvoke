...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.1.0-beta.795.xcframework.zip",
			checksum: "28841693e9da93fb9400f84e206f6039c1e50615f69240341f8ab05c92dcfc8a"
		)
	]
)