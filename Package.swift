...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta.20230617144628.xcframework.zip",
			checksum: "defb966c7b1c6a4a856fd1cd15c0d7db297913e8546029dc0c790e094ea62c86"
		)
	]
)