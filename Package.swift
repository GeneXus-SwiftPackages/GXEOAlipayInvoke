...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXStandardClasses.git", exact: "1.6.0-rc.0")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/preview/GXEOAlipayInvoke-1.6.0-rc.0.xcframework.zip",
			checksum: "c6e3c3a64ca0b686d84161cea092339e16ccf323ab2c671f8e8559374793fb7a"
		)
	]
)