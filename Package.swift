...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230509112137.xcframework.zip",
			checksum: "58689df9a706f3b0738a5f39d572be41447592a4873ade338d18390a9c69e736"
		)
	]
)