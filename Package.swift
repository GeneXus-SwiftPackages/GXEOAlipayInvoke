...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "b0706a9d7f1ccf4e64eeeca7bea10edf406cd6a4248846f768b35e7d7669ac16"
		)
	]
)