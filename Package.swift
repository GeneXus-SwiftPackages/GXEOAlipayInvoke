...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.1.0-beta.794.xcframework.zip",
			checksum: "e72d18bdd1c25d51e003528b513f4ca713c77b6c5f6563e968f5b0412d5d4d17"
		)
	]
)