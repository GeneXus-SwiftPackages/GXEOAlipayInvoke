...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.1.0-beta.8.xcframework.zip",
			checksum: "499adccb84921259faf463cfbd35970599a48315c4a1e99bcf0a9dd5d5427b6d"
		)
	]
)