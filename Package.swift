...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230328162416.xcframework.zip",
			checksum: "0da780ba9b82c5334181039b21f174027ed1174c9238fe4db8396d68bccac41b"
		)
	]
)