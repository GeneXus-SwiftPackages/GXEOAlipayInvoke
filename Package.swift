...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230327200102.xcframework.zip",
			checksum: "640d5ddb875616fb54c3e84f317e1f2401f087d95d427fa3557e4e789fcaddb3"
		)
	]
)