...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230316142352.xcframework.zip",
			checksum: "823cd04165d0974083a77f429c3453ea509f8f4d55a3f0f4f66f793405139375"
		)
	]
)