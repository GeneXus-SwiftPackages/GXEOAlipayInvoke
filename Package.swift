...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230515145153.xcframework.zip",
			checksum: "20ef3a1371f90adf495909d6d2733f23f279ec745d7e38fb131fb20a68bb3077"
		)
	]
)