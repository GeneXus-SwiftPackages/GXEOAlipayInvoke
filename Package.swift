...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230509131236.xcframework.zip",
			checksum: "3356b2bb4a613d733f099547054c7921514e0f130fe298bfeeb2b09b260d854c"
		)
	]
)