...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXStandardClasses.git", exact: "1.2.0-rc.29")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/preview/GXEOAlipayInvoke-1.2.0-rc.29.xcframework.zip",
			checksum: "70a73b859b434a6c98927bf07a4395b0d73ced46b149f4e3b6b2b7f4c58abfbc"
		)
	]
)