...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "8cb77c161fc970e7c36e5631fdbfa074a312764d7d978a828ad97e869f9f4ebe"
		)
	]
)