...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/releases/GXEOAlipayInvoke-1.2.0.xcframework.zip",
			checksum: "41c0335ba3c8a0d8d2f561883fa5d6a4f127cd450600491dec2e296e63a87531"
		)
	]
)