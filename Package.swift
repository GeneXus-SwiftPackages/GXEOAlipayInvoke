...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230303092649.xcframework.zip",
			checksum: "80f72367a5553f316fc8d0d369c24065ca29def4765ed7e325a947510eed07ee"
		)
	]
)