...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/releases/GXEOAlipayInvoke-1.1.2.xcframework.zip",
			checksum: "7a58dbf8a01520f5de5ea6ae3934e10078b0788eabfcf0fd4e187c78384e4ac5"
		)
	]
)