...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/preview/GXEOAlipayInvoke-1.1.0-rc.4.xcframework.zip",
			checksum: "5bd50ae4d2790c9f26e045d31136b6ab03f29dcb9ea2a87a1101899a321899f4"
		)
	]
)