...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOAlipayInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOAlipayInvoke-1.0.0-beta+20230309134517.xcframework.zip",
			checksum: "e5252e2fcdc57f30a7aaf0e91360526804b40512868f81b443aa3aa239a8f848"
		)
	]
)